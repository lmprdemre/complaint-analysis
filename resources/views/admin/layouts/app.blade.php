...
<div id="wrapper">
                    ...
                    <ul class="dropdown-menu dropdown-user animated flipInY">
                        <li>
                            <div class="dw-user-box">
                                ...
                                <div class="u-text">
                                    <h4>@if(isset($user) && $user['company_name']){{ucfirst($user['company_name'])}}@endif</h4>
                                    <p class="text-muted">@if(isset($user) && $user['email']){{$user['email']}}@endif</p><a href="/admin/profile" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                            </div>
                        </li>
    ...
    <footer class="footer text-center"> 2018 &copy;  Complaint Analysis</footer>
    <!-- ============================================================== -->
    <!-- End Page Content -->
    <!-- ============================================================== -->
</div>
